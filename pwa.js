...
const cacheName = 'MidtermAxelson-2021-03-15 13:34:33.582035'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'MidtermAxelson'.length) === 'MidtermAxelson') {
